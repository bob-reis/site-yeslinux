...
export default component$(() => {
  ...
  // Tema fixo (YesLinux): remoção de seletor de tema e GitHub do header
      ...
      <div class="navbar bg-base-100">
        <div class="flex-1">
          ...
          <a href="/" class="btn btn-ghost text-xl flex capitalize">
            <label for="my-drawer-3" aria-label="open sidebar" class="tooltip tooltip-bottom" data-tip="Ver todas as páginas"><Icon class="mr-2" icon="shield" width={28} height={28}  /></label>
            <h1>Defesa Digital</h1>
          </a>
        </div>
      ...
      <div class="drawer-side z-10">
        ...
        <ul class="rounded-box menu p-4 w-80 min-h-full bg-base-200">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://github.com/Lissy93/personal-security-checklist/?tab=readme-ov-file#contributing">Contribuir</a>
              </li>
              <li>
      ...
      <dialog id="settings_modal" class="modal">
        <div class="modal-box">
          <div class="tabs tabs-lifted">
            ...
            <a class="tab" href="/about">Sobre</a>
          </div>
