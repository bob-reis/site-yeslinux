...
# Links Fantásticos de Privacidade e Segurança
...
*Uma lista curada de guias, artigos, ferramentas e mídia notáveis - relacionados à segurança digital, liberdade na internet e privacidade online*

**Veja também**: [Lista de Segurança Pessoal](https://github.com/Lissy93/personal-security-checklist/blob/master/README.md) | [Software Respeitador de Privacidade](https://github.com/Lissy93/personal-security-checklist/blob/master/5_Privacy_Respecting_Software.md) | [Gadgets de Segurança](/6_Privacy_and-Security_Gadgets.md) | [Por que a Privacidade Importa](/0_Why_It_Matters.md) | [TLDR](/2_TLDR_Short_List.md)🔐

## Sumário

- **Informações e Guias**
  - [Guias Como-Fazer](#guias-como-fazer)
  - [Artigos](#artigos)
  - [Blogs](#blogs)
- **Mídia**
  - [Livros](#livros)
...
- **Ferramentas e Serviços de Segurança**
  ...
  - Software Respeitador de Privacidade, movido para [aqui](https://github.com/Lissy93/awesome-privacy)
  - Hardware de Segurança, movido para [aqui](/6_Privacy_and-Security_Gadgets.md)
- **Pesquisa**
  - [Dados e APIs](#dados-apis-e-visualizações)
  - [Acadêmico](#acadêmico)
- **Organizações**
  - [Fundações](#fundações)
  - [Organizações Governamentais e Independentes](#governança)
- **Mais Listas**
  - [Mega Guias](#mega-guias)
  - [Outras Listas de Segurança do GitHub](#mais-listas-awesome-do-github)


## Guias Como-Fazer

- **Proteção contra Ameaças**
  - Proteja-se contra golpe de SIM-swap: via [Wired](https://www.wired.com/story/sim-swap-attack-defend-phone)
  - Como identificar um ataque de phishing: via [EFF](https://ssd.eff.org/en/module/how-avoid-phishing-attacks)
  - Proteção contra Roubo de Identidade: via [Restore Privacy](https://restoreprivacy.com/identity-theft-fraud)
  - Proteção contra keylogging, com KeyScrambler: via [TechRepublic](https://www.techrepublic.com/blog/it-security/keyscrambler-how-keystroke-encryption-works-to-thwart-keylogging-threats)
  - Guia para Verificações de Hash, para garantir que um programa não foi adulterado: via [ProPrivacy](https://proprivacy.com/guides/how-why-and-when-you-should-hash-check)
  - Excluir Permanentemente e com Segurança 'Arquivos e Diretórios' no Linux: via [TechMint](https://www.tecmint.com/permanently-and-securely-delete-files-directories-linux/)
- **Redes**
  - Como habilitar DNS sobre HTTPS: via [GeekWire](https://geekwire.co.uk/privacy-and-security-focused-dns-resolver)
  - Como resolver problemas de vazamento de DNS: via [DNSLeakTest](https://www.dnsleaktest.com/how-to-fix-a-dns-leak.html) 
  - Proteja-se contra Vazamentos WebRTC: via [Restore Privacy](https://restoreprivacy.com/webrtc-leaks)
  - Dicas de privacidade de ISP e DNS: via [bluz71](https://bluz71.github.io/2018/06/20/digital-privacy-tips.html)
  - Guia para iniciantes sobre como começar com Tor: via [ProPrivacy](https://proprivacy.com/privacy-service/guides/ultimate-tor-browser-guide)
  - Guia para iniciantes sobre I2P: via [The Tin Hat](https://thetinhat.com/tutorials/darknets/i2p.html)
  - Sobre o uso de VPN e Tor juntos: via [ProPrivacy](https://proprivacy.com/vpn/guides/using-vpn-tor-together)
  - Como usar `__nomap`, para reduzir exposição pública de SSID: via [ghacks](https://www.ghacks.net/2014/10/29/add-_nomap-to-your-routers-ssid-to-have-it-ignored-by-google-and-mozilla/)
  - Configurações de roteador atualizadas para segurança avançada: via [RouterSecurity.org](https://routersecurity.org/)
- **Comunicação**
  - Autodefesa de E-mail, Configure seu cliente de e-mail com segurança, do zero - via [FSF.org](https://emailselfdefense.fsf.org)
  - Como evitar Ataques de Phishing: via [EFF](https://ssd.eff.org/en/module/how-avoid-phishing-attacks)
  - Como usar PGP: Via EFF - [Windows](https://ssd.eff.org/en/module/how-use-pgp-windows), [MacOS](https://ssd.eff.org/en/module/how-use-pgp-mac-os-x) e [Linux](https://ssd.eff.org/en/module/how-use-pgp-linux)
  - Guia Passo a Passo para Gerar Chaves GPG Mais Seguras: via [spin.atomicobject.com](https://spin.atomicobject.com/2013/11/24/secure-gpg-keys-guide/)
  - Como Manter Anonimato em Transações de Bitcoin: [coinsutra.com](https://coinsutra.com/anonymous-bitcoin-transactions/)
  - Guia para Iniciantes do Signal (aplicativo de mensagens seguras): via [Freedom of the Press Foundation](https://freedom.press/news/signal-beginners/)
  - Como usar mensagens OTR com Adium (MacOS): via [CalyxiIstitute.org](https://calyxinstitute.org/docs/howto-encrypted-instant-messaging-with-osx-adium-and-otr)
  - Guia completo para usar e-mails em texto simples: via [useplaintext.email](https://useplaintext.email/)
- **Dispositivos**
  - Como Habilitar Criptografia em seus Dispositivos: via [SpreadPrivacy.com](https://spreadprivacy.com/how-to-encrypt-devices/)
  - Como Excluir seus Dados com Segurança: Via EFF - [Windows](https://ssd.eff.org/en/module/how-delete-your-data-securely-windows), [MacOS](https://ssd.eff.org/en/module/how-delete-your-data-securely-macos) e [Linux](https://ssd.eff.org/en/module/how-delete-your-data-securely-linux) 
  - Camadas de Segurança Tecnológica Pessoal: via [The Wire Cutter](https://thewirecutter.com/blog/internet-security-layers)
  - Guias de Privacidade Específicos por Dispositivo: via [SpreadPrivacy](https://spreadprivacy.com/tag/device-privacy-tips/)
    - Para: [Windows 10](https://spreadprivacy.com/windows-10-privacy-tips/), [MacOS](https://spreadprivacy.com/mac-privacy-tips/), [Linux](https://spreadprivacy.com/linux-privacy-tips/), [Android](https://spreadprivacy.com/android-privacy-tips/) e [iOS](https://spreadprivacy.com/iphone-privacy-tips/)
  - Guia para limpar Sistemas Operacionais Windows de investigações forenses: por u/moschles, via [Reddit](https://www.reddit.com/r/security/comments/32fb1l/open_guide_to_scrubbing_windows_oss_from_forensic)
  - Lista selecionada de técnicas de Fortalecimento de Domínio Windows: por @PaulSec, via: [GitHub](https://github.com/PaulSec/awesome-windows-domain-hardening)
  - Configurando Gboard para melhor Privacidade: via [Ghacks](https://www.ghacks.net/2016/12/21/configure-gboard-privacy-google-keyboard/)
  - Configurações para atualizar no iPhone, para melhor privacidade: via [lifehacker](https://lifehacker.com/the-privacy-enthusiasts-guide-to-using-an-iphone-1792386831)
  - Como verificar Permissões de Aplicativos (Android, iOS, Mac & Windows): via [Wired](https://www.wired.com/story/how-to-check-app-permissions-ios-android-macos-windows/)
  - Como gerenciar Unidades de Auto-Criptografia: via [TechSpot](https://www.techspot.com/guides/869-self-encrypting-drives/)
  - Fortaleça a Segurança do seu MacOS: via [@drduh no GitHub](https://github.com/drduh/macOS-Security-and-Privacy-Guide)
- **Software**
  - Guia completo para configurar o Firefox para Privacidade + Velocidade: via [12bytes](https://12bytes.org/articles/tech/firefox/firefoxgecko-configuration-guide-for-privacy-and-performance-buffs/)
  - Guia de Configuração do Firefox para Iniciantes: via [12bytes](https://12bytes.org/articles/tech/firefox/the-firefox-privacy-guide-for-dummies/)
  - Como usar Vera Crypt: via [howtogeek](https://www.howtogeek.com/108501/the-how-to-geek-guide-to-getting-started-with-truecrypt)
  - Como usar KeePassXC: via [EFF](https://ssd.eff.org/en/module/how-use-keepassxc)
  - Como usar o addon de navegador uMatrix para bloquear rastreadores: via [ProPrivacy](https://proprivacy.com/privacy-service/guides/lifehacks-setup-umatrix-beginners) 
  - Como configurar Autenticação de Dois Fatores em sites comuns: via [The Verge](https://www.theverge.com/2017/6/17/15772142/how-to-set-up-two-factor-authentication)
  - Como usar recursos avançados de pesquisa do DuckDuckGo: via [Ghacks](https://www.ghacks.net/2013/03/24/duckduckgo-another-bag-of-tricks-to-get-the-most-out-of-it/)
  - Como usar Cryptomator (criptografar arquivos no armazenamento em nuvem): via [It's Foss](https://itsfoss.com/cryptomator/)
- **Segurança Física**
  - Guia para Viver Anonimamente, Remoção de Dados Pessoais e Congelamento de Crédito: via [IntelTechniques.com](https://inteltechniques.com/data/workbook.pdf)
  - Escondendo-se da Vigilância Física: via [Snallabolaget](http://snallabolaget.com/hiding-from-surveillance-how-and-why)
  - Guia para desistir de listas de dados públicos e listas de marketing: via [World Privacy Forum](https://www.worldprivacyforum.org/2015/08/consumer-tips-top-ten-opt-outs)
  -
- **Empresarial**
  - Uma lista básica para fortalecer a conformidade com GDPR: via [GDPR Checklist](https://gdprchecklist.io)
- **Informações de Referência**
  - Um diretório de websites, apps e serviços que suportam 2FA: via [TwoFactorAuth.org](https://twofactorauth.org)
  - Um diretório de links diretos para excluir sua conta de serviços web: via [JustDeleteMe.xyz](https://justdeleteme.xyz)
  - Dados de Comparação Imparcial de VPN: via [ThatOnePrivacySite](https://thatoneprivacysite.net/#detailed-vpn-comparison)
  - Termos de Serviço; Não Lidos - Recurso vital que resume e extrai os detalhes-chave das Políticas de Privacidade/Termos de Serviço, visando corrigir os problemas causados por concordar cegamente com esses Termos: via [tosdr.org](https://tosdr.org/)
  - Alternativas gratuitas, de código aberto e que respeitam a privacidade para softwares populares: via [Switching.Software](https://switching.software/)
  - Análises de produtos de uma perspectiva de privacidade, pela Mozilla: via [Privacy Not Included](https://foundation.mozilla.org/en/privacynotincluded)
  - Catálogo de Vigilância - Base de dados de equipamentos de vigilância governamental secretos, Snowden: via [The Intercept](https://theintercept.com/surveillance-catalogue)
    - Veja também: O código-fonte, no WikiLeaks [Vault7](https://wikileaks.org/vault7) e [Vault8](https://wikileaks.org/vault8), e o [comunicado à imprensa](https://wikileaks.org/ciav7p1) que o acompanha
  - Quem Está no Seu Lado? - Quais empresas entregam e cumprem com Solicitações de Dados do Governo em 2019: via [EFF](https://www.eff.org/wp/who-has-your-back-2019)
  - Verifique quem são seus representantes locais e governamentais em sua área [WhoAreMyRepresentatives.org](https://whoaremyrepresentatives.org)
  - Projeto aberto para classificar, anotar e arquivar políticas de privacidade: via [PrivacySpy.org](https://privacyspy.org)
  - Hosts para bloquear: via [someonewhocares/ hosts](https://someonewhocares.org/hosts) / [StevenBlack/ hosts](https://github.com/StevenBlack/hosts)
  - Números Mágicos - Tabela atualizada de assinaturas de arquivos, para identificar/verificar se os arquivos não foram adulterados: via [GaryKessler](https://www.garykessler.net/library/file_sigs.html)
  - Lista de intervalos de IP por país: via [Nirsoft](https://www.nirsoft.net/countryip)
  - Base de dados de senhas padrão para vários dispositivos por fabricante e modelo: via [Default-Password.info](https://default-password.info)
- **Segurança digital e física tudo-em-um**
  - Umbrella: um aplicativo de código aberto para iOS/Android/Web para aprender e gerenciar segurança digital, operacional e física (desde comunicação segura até lidar com sequestro) via [Security First](https://www.secfirst.org)



## Artigos
- **Geral**
  - Manifesto de 8 pontos sobre por que a Privacidade Importa: via [whyprivacymatters.org](https://whyprivacymatters.org)
  - Repensando Anúncios Digitais: via [TheInternetHealthReport](https://internethealthreport.org/2019/rethinking-digital-ads)
- **Criptografia**
  - Visão geral de projetos trabalhando em e-mail seguro de próxima geração: via [OpenTechFund](https://github.com/OpenTechFund/secure-email)
  - Anatomia de uma Chave GPG: via [@DaveSteele](https://davesteele.github.io/gpg/2014/09/20/anatomy-of-a-gpg-key/)
- **Vigilância**
  - Doze Milhões de Telefones, Um Conjunto de Dados, Zero Privacidade: via [NY Times](https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html)
  - Envio de dados do Windows: via [The Hacker News](https://thehackernews.com/2016/02/microsoft-windows10-privacy.html)
  - Seu Antivírus está te espionando?: via [Restore Privacy](https://restoreprivacy.com/antivirus-privacy)
  - O que seu carro sabe sobre você?: via [Washington Post](https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out)
  - Resulta que Ferramentas de Espionagem Stingray da Polícia Podem Realmente Gravar Chamadas: via [Wired](https://www.wired.com/2015/10/stingray-government-spy-tools-can-record-calls-new-documents-confirm)
  - Polícia do Reino Unido Acessando Dados de Telefone Privados Sem Mandado: via [Restore Privacy](https://restoreprivacy.com/uk-police-accessing-phone-data)
  - Raiva Contra o Domínio de Dados: via [Privacy International](https://privacyinternational.org/long-read/3734/rage-against-data-dominance-new-hope)
  - Arquivos da NSA Decodificados, O que as revelações significam para você: via [The Guardian](https://www.theguardian.com/world/interactive/2013/nov/01/snowden-nsa-files-surveillance-revelations-decoded)
  - Como Rastrear um Celular Sem GPS—ou Consentimento: via [Gizmodo](https://gizmodo.com/how-to-track-a-cellphone-without-gps-or-consent-1821125371)
  - Aplicativos capazes de rastrear localização de dispositivos, através do gerenciador de energia: via [Wired](https://www.wired.com/2015/02/powerspy-phone-tracking/)
  - Hackers e governos podem te ver através da câmera do seu telefone: via [Business Insider](https://www.businessinsider.com/hackers-governments-smartphone-iphone-camera-wikileaks-cybersecurity-hack-privacy-webcam-2017-6)
  - Solicitações de Dados de Geo-Cerca da Polícia - Como um ciclista inocente se tornou suspeito quando a polícia acessou seus dados de localização do Google: via [Daily Mail](https://www.dailymail.co.uk/news/article-8086095/Police-issue-warrant-innocent-mans-Google-information.html)
  - IBM Usou Filmagens de Vigilância do NYPD para Desenvolver Tecnologia que Permite à Polícia Pesquisar por Cor da Pele: via [TheIntercept](https://theintercept.com/2018/09/06/nypd-surveillance-camera-skin-tone-search/)
- **Threats**
