...
# Hardware para Proteger Privacidade e Segurança
Uma lista selecionada de dispositivos (DIY e pré-construídos) para ajudar a preservar privacidade e melhorar a segurança cibernética física 🔐

**Muito longo? 🦒** Veja a [versão TLDR](/2_TLDR_Short_List.md#security-hardware) em vez disso.

Veja também, [The Hackers Hardware Toolkit](https://raw.githubusercontent.com/yadox666/The-Hackers-Hardware-Toolkit/master/TheHackersHardwareToolkit.pdf) por [@yadox666](https://github.com/yadox666) - Guia definitivo de gadgets para red teamers e pesquisadores de segurança

**Nota**: Esta seção é apenas para se divertir um pouco, é totalmente possível manter-se seguro e anônimo sem precisar construir ou comprar nada. Como mais dispositivos foram adicionados, não foi possível testar tudo aqui, então esses produtos não devem ser considerados recomendações, apenas ideias interessantes e um pouco de diversão
...
#### Sumário
- [Básicos](#básicos)
- [Produtos de Segurança DIY](#produtos-de-segurança-diy)
- [Gadgets de Segurança Paranóicos](#gadgets-de-segurança-paranóicos)
- [Segurança de Rede](#segurança-de-rede)
- [Dispositivos de Computação Seguros](#dispositivos-de-computação-seguros)
- [Armazenamento Criptográfico de Hardware](#armazenamento-criptográfico-de-hardware)
- [Bloqueadores de Dados USB](#bloqueadores-de-dados-usb)
- [Chaves FIDO U2F](#chaves-fido-u2f)
- [Carteiras Cripto](#carteiras-cripto)


## Básicos
(Todos os produtos desta seção foram testados.)

**Item** | **Descrição**
--- | ---
**Bloqueador de Dados USB**<br>[![Data Blocker](https://i.ibb.co/jG3dpGW/1.jpg)](https://amzn.to/2HDArRP) | Existem muitos exploits que permitem a um atacante infectar seu dispositivo com malware e/ou roubar dados, quando você o conecta ao que parece ser uma tomada USB de energia. Ao carregar seu telefone durante uma viagem, um bloqueador de dados USB impedirá que qualquer coisa além de energia chegue ao seu dispositivo, removendo a conexão entre os 2 fios de dados. A marca PortaPower também vem com um chip de carregamento rápido, já que sem a conexão de dados, seu dispositivo carregaria na velocidade mínima
**Bloqueador de Microfone**<br>[![__](https://i.ibb.co/BKQTCbQ/2.jpg)](https://amzn.to/2uQ3r5L) | Um bloqueador de microfone é um dispositivo que proíbe hacking de áudio, na forma de um acessório de hardware para smartphones, laptops, etc. Funciona como um conector de microfone fictício, fazendo com que o dispositivo pense que tem um microfone conectado, e, portanto, desabilita o interno
**Bolsa Faraday**<br>[![__](https://i.ibb.co/HBBG0QL/3.jpg)](https://amzn.to/3bIkfw4) | [Escudo Faraday](https://en.wikipedia.org/wiki/Faraday_cage) é um invólucro que bloqueia campos eletromagnéticos. É útil para manter qualquer dispositivo que possa ser hackeado por enviar ou receber sinais, como chaves de carro ou smartphone. Versões [maiores](https://amzn.to/2UTZOGM) estão disponíveis para tablets e laptops
**Cartões de Bloqueio RFID**<br>[![__](https://i.ibb.co/m4GtMdj/4.jpg)](https://amzn.to/38ycMxN) | Se você está preocupado com roubo de cartão, pode usar uma capa de bloqueio RFID para proteger seus cartões de pagamento sem contato e de identidade. No entanto, há relativamente poucos crimes de roubo de RFID registrados, e a maioria dos cartões de crédito tem um limite de pagamento sem contato baixo
**Protetores de Webcam**<br>[![__](https://i.ibb.co/X7B1WsH/5.jpg)](https://amzn.to/2uEz16H) | Protetores de webcam são bastante autoexplicativos, eles cobrem fisicamente as lentes da câmera do seu laptop ou telefone, para impedir que um ator malicioso (hacker, governo, corporação, etc.) o observe pela câmera. Pode parecer paranóico, mas infelizmente acontece, e é um processo relativamente simples para alguém obter acesso remoto à webcam. Até Mark Zuckerberg [cobre sua webcam](https://www.geek.com/tech/mark-zuckerberg-tapes-up-his-webcam-and-snowden-says-you-should-too-1659083/)! Claro, você poderia simplesmente usar uma fita adesiva, em vez de comprar uma capa
**Carteira Prokey**<br>[![__](https://i.ibb.co/m53MmCL/prokey.jpg)](https://prokey.io/?reflink=67e4a39bc5cd4c04bd7f38b50b041c1f) | Prokey Optimum é uma carteira de hardware offline segura e fácil de usar, que funciona diretamente através do navegador (no Windows, Mac, Linux e Android), sem a necessidade de instalar aplicativos. Tanto o firmware quanto o aplicativo de navegador são [código aberto](https://github.com/prokey-io), e oferece suporte nativo a [mais de 1000 moedas e tokens](https://prokey.io/all-coins). Tem preço acessível de £42/ $59, com envio gratuito para todo o mundo e suporte ao cliente
**Bloqueadores de Porta**<br>[![__](https://i.ibb.co/fYPVnK5/6.jpg)](https://amzn.to/327Yn9n) | Existem muitos ataques que envolvem um atacante inserindo um dispositivo USB (como BadUSB/ Rubber Ducky/ Malduino) em uma porta USB aberta. Adicionar um bloqueador de porta não o torna completamente seguro, pois o atacante poderia dedicar tempo para tentar removê-lo, mas poderia protegê-lo de um ataque oportunista
**Filtro de Privacidade**<br>[![__](https://i.ibb.co/KjkTbGN/7.jpg)](https://amzn.to/3bAa9xv) | Filtros de privacidade são folhas de plástico polarizadas, que quando colocadas sobre uma tela de computador impedem a visibilidade da tela de qualquer ângulo que não seja diretamente em frente. Tornam mais difícil para qualquer pessoa olhar por cima do seu ombro e ver seus dados confidenciais
**YubiKey**<br>[![__](https://i.ibb.co/PGtbwxN/8.jpg)](https://amzn.to/38wcG9R) | O YubiKey é um pequeno dispositivo de hardware usado para proteger o acesso em dispositivos móveis, computadores e servidores para todas as suas contas online. Permite autenticação de dois fatores, protegendo, portanto, qualquer pessoa além de você de fazer login. Diz-se que é mais conveniente e mais seguro do que usar um autenticador móvel, mas existem razões para e contra
**Pen Drive Criptografado Kingston**<br>[![__](https://i.ibb.co/ScRFhdt/9.jpg)](https://amzn.to/38xsnO5) | Boa relação custo-benefício, fácil de usar, sem necessidade de instalação. Criptografia de hardware integrada e alta proteção por senha. Também permite opcionalmente backup automático na nuvem para proteger contra perda de dados (o que não diz muito sobre a confiança deles neste dispositivo USB, mas brincadeiras à parte) este é um dispositivo muito acessível e bem avaliado
**Unidade USB 3.0 Criptografada por Hardware**<br>[![__](https://i.ibb.co/p3MzFHF/11.jpg)](https://amzn.to/2vD32Ug) | Independente de Sistema Operacional e Plataforma, com 100% de criptografia de hardware, funciona perfeitamente com todos os sistemas operacionais. USB 3.0 com Velocidades de Leitura/Gravação de 116/43 MBps. Compatível com GDPR e FIPS 140-2 Nível 3, Certificado NLNCSA DEP-V & NATO Restricted Level com criptografia de hardware AES-XTS 256-bit em tempo real
**Disco Rígido Externo Criptografado por Hardware**<br>[![__](https://i.ibb.co/BV5k29v/12.jpg)](https://amzn.to/37pTmK8) | Semelhante ao drive USB 3.1 criptografado por hardware da iStorage, este disco rígido externo tem alta capacidade e forte criptografia de hardware. Os dados são criptografados com o Algoritmo de Criptografia Validado FIPS PUB 197, e com um pin alfanumérico de 7 a 15 dígitos, com recursos de apagamento para múltiplas tentativas de login com falha
**Fingbox - Monitoramento de Rede Doméstica**<br>[![__](https://i.ibb.co/nkMxwz9/14.jpg)](https://amzn.to/2V5gATx) | Fing Box é um complemento opcional para o [Aplicativo Fing](https://www.fing.com/products/fing-app). Ele fornece recursos de monitoramento e segurança de rede para proteger sua rede doméstica/trabalho. Além da funcionalidade do aplicativo, o FingBox permite bloquear invasores e notificá-lo sobre dispositivos desconhecidos, bem como analisar vulnerabilidades de rede, como portas abertas. Você também pode ver quais dispositivos estão próximos à sua casa em que horário (mesmo que não estejam conectados ao seu WiFi) e melhorar a velocidade da rede com análise programada e alocação de largura de banda. O ideal é experimentar o aplicativo Fing sozinho antes de comprar o FindBox, mas ambos são ótimos produtos para monitoramento e segurança de rede
**Apagador de Unidade Inicializável**<br>[![__](https://i.ibb.co/P11d0YH/15.jpg)](https://amzn.to/2SsL67Y) | Um USB inicializável fácil de usar irá apagar completamente seu disco rígido com destruição de nível militar, tornando quase impossível recuperar qualquer arquivo ou dado pessoal. Isso deve ser feito antes de vender ou descartar qualquer disco rígido. Claro, existem vários arquivos .ISOs que você pode baixar e gravar em um USB por conta própria se não quiser gastar dinheiro, mas este USB suporta todos os dispositivos e é rápido e fácil de usar, com resultados excelentes
**Tela de Privacidade para Dispositivos Móveis**<br>[![__](https://i.ibb.co/Zg9QG1j/17.jpg)](https://amzn.to/2OZO3Lc) | Semelhante ao filtro de privacidade de laptop/monitor, este protetor de tela impedirá que qualquer pessoa veja o que está na sua tela ao ler de um ângulo
**Cadeado Kensington**<br>[![__](https://i.ibb.co/TKHV5d3/20.jpg)](https://amzn.to/38zu0e2) | Bastante autoexplicativo, este cadeado tornará mais difícil para alguém roubar seu laptop e acessar seus dados. Claro, isso requer que seu laptop tenha o [Slot de Segurança Kensington](https://en.wikipedia.org/wiki/Kensington_Security_Slot), o que muitos têm
**Roupa Anti-Vigilância**<br>[![__](https://i.ibb.co/Gk8jBBm/21.jpg)](https://adversarialfashion.com) | O reconhecimento facial está sendo implementado na maioria dos países atualmente, os padrões nessas roupas confundirão o reconhecimento facial, de objetos e de placas de identificação, injetando dados aleatórios nos sistemas, tornando mais difícil para sistemas automatizados monitorar e rastrear você
**Solo Key**<br>[![__](https://i.ibb.co/8PFQRDy/26.jpg)](https://amzn.to/37CsOpj) | Outra chave de segurança física FIDO2 para autenticação de dois fatores e armazenamento de chaves de criptografia. As SoloKeys possuem hardware e software de código aberto, são fáceis de usar imediatamente, mas também podem ser usadas por desenvolvedores e makers, já que há uma CLI bem documentada
**Nano Ledger**<br>[![__](https://i.ibb.co/HdVyPzb/22.jpg)](https://amzn.to/37q1cn6) | Se você possui Bitcoin ou outras criptomoedas, uma das formas mais seguras de armazenar, enviar e receber moedas é com uma carteira de hardware. A Ledger tem uma sólida reputação quando se trata de criptografia de hardware, e o princípio principal por trás de suas carteiras é fornecer isolamento completo entre as chaves privadas e seu computador ou smartphone facilmente hackeável
**Armazenamento Frio**<br>[![__](https://i.ibb.co/nj6xyv1/23.jpg)](https://amzn.to/2HqVy9x) | Se você não planeja gastar sua criptomoeda em breve e não deseja confiar em uma solução baseada em tecnologia, considere esta carteira de armazenamento frio de metal. Diferentemente de escrever sua chave privada em papel, esta não desvanecerá e não pode ser destruída por água, fogo ou outras circunstâncias ambientais. Claro, você poderia simplesmente gravar sua chave em uma pequena folha de alumínio
**Anonabox**<br>[![__](https://i.ibb.co/L177XDJ/24.jpg)](https://amzn.to/2UWtP8E) | Roteador Tor plug-and-play, que pode ser usado com WiFi público durante viagens ou em casa. O Anonabox fornece acesso fácil à deep web e permite burlar a censura, proteger sua localização, dissuadir a coleta de dados e muito mais. Pode ser usado com VPN ou para hospedagem online. Claro, você poderia construir um produto similar usando um Raspberry Pi e um extensor de alcance WiFi
**Detector de Deautenticação**<br>[![__](https://i.ibb.co/BqNGRCW/19.jpg)](https://amzn.to/2HtUy4B) | A maioria dos ataques WiFi começa enviando pacotes de deautenticação, fazendo com que os clientes conectados sejam brevemente desconectados da rede. Este [ESP8266](https://en.wikipedia.org/wiki/ESP8266) vem pré-gravado com o detector de deautenticação de [@SpaceHuhn](https://github.com/spacehuhn) (que você pode ver [aqui, no GitHub](https://github.com/spacehuhn/DeauthDetector)). Uma vez que detecta [quadros de deautenticação ou desassociação](https://mrncciew.com/2014/10/11/802-11-mgmt-deauth-disassociation-frames), ele ativará um alto-falante para notificá-lo
**WiPhone**<br>[![__](https://i.ibb.co/grnJjKt/wiphone.jpg)](https://www.wiphone.io/) | Um telefone totalmente de código aberto, modular e facilmente personalizável para VOIP e LoRa. Ótimo para fazer chamadas gratuitas por WiFi, comunicar-se localmente por LoRa ou simplesmente mexer graças aos seus pinos ESP32
**Librem 5**<br>[![__](https://i.ibb.co/3TNh5Vt/l5-v1-front-100x100.png)](https://shop.puri.sm/shop/librem-5/) | Smartphone focado em segurança e privacidade pela Purism. Com interruptores de hardware e software especialmente projetado, este dispositivo roda Linux e não te rastreia. Separa a CPU do Cellular Baseband, usa Comunicação IP-Nativa em Primeiro Lugar e Comunicação Descentralizada por Padrão. O código-fonte é controlado pelo usuário e possui proteção de segurança em camadas. A Purism também possui [outros produtos focados em segurança](https://puri.sm/products)
...
- [Software de Privacidade Respeitoso](https://github.com/Lissy93/awesome-privacy)
- [Lista Definitiva de Segurança Pessoal](/README.md)
- [Por que Privacidade e Segurança Importam](/0_Why_It_Matters.md)
- [Links Adicionais + Mais Conteúdo Incrível](/4_Privacy_And_Security_Links.md)


Contribuições são bem-vindas e apreciadas - para propor uma edição [abra um issue](https://github.com/Lissy93/personal-security-checklist/issues/new/choose) or [crie um PR](https://github.com/Lissy93/personal-security-checklist/pull/new/master). Veja: [`CONTRIBUTING.md`](/.github/CONTRIBUTING.md)
...
Achou útil? Considere compartilhar com outras pessoas, para ajudá-las a melhorar sua segurança digital 😇
