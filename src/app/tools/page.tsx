            ...
            <ul className="text-sm space-y-3">
              <li>
                <div className="flex flex-col">
                  ...
                  <span className="text-text-muted">Guia prático para proteger sua vida digital.</span>
                  <Link className="text-primary hover:underline w-fit inline-flex items-center gap-1" href="/tools/blue-team/personal-security-checklist">
                    Abrir ferramenta <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
              </li>
              <li className="flex items-center justify-between opacity-80 text-text-muted">
