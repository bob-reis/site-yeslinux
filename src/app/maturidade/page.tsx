  ...
  return (
    <main className="relative">
      <Section
        ...
        description="Avalie rapidamente a maturidade de segurança da informação da sua organização em domínios-chave."
      >
        {/* Questionário */}
        <section id="questionnaireSection" className="space-y-6">
      ...
      <Script
        ...
        onLoad={() => {
          ...
          // @ts-ignore - these are defined by the loaded script
